...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "**ملحوظة:** يتم دعم الصور والفيديوهات من إنستغرام.",
...
async def download_instagram(url: str):
    ...
    try:
        ...
        # البحث عن ملفات الوسائط: الفيديو (.mp4) أو الصورة (.jpg, .png)
    ...
    if "tiktok.com" in url:
        ...
        if media_files:
            for media_path in media_files:
                with open(media_path, 'rb') as f:
                    if media_path.endswith('.mp4'):
                        ...
                        # هذا الجزء هو المسؤول عن إرسال الصور (jpg, png)
            ...
            try:
                ...
                print(f"⚠️ فشل في تنظيف الملفات: {e}")
